...
namespace CryptoTrading.Migrations
{
    ...
    [Migration("20251113035659_AddAuditAndConfiguration")]
    partial class AddAuditAndConfiguration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CryptoTrading.Models.AuditEvent", b =>
                {
                    b.Property<ulong>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("CryptoTrading.Models.BotRiskConfiguration", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("MaxAllowedCapital")
                    ...
                    b.Property<decimal>("MaxSlippage")
                        .HasColumnType("decimal(10,4)");
                    ...
                    b.ToTable("BotRiskConfigurations", (string)null);
                });

            modelBuilder.Entity("CryptoTrading.Models.BotStrategyDefinition", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.HasIndex("StrategyKey", "Version")
                        .IsUnique();

                    b.ToTable("BotStrategyDefinitions", (string)null);
                });

            modelBuilder.Entity("CryptoTrading.Models.ClientOrderIdempotency", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ClientOrderIdempotency", (string)null);
                });
            ...
            modelBuilder.Entity("CryptoTrading.Models.FeeLedger", b =>
                {
                    b.Property<ulong>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("BIGINT UNSIGNED");
                    ...
                    b.ToTable("FeeLedger", (string)null);
                });
            ...
            modelBuilder.Entity("CryptoTrading.Models.ReconciliationResult", b =>
                {
                    b.Property<ulong>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("BIGINT UNSIGNED");
                    ...
                    b.Property<DateTime>("ReconciliationTime")
                        .HasColumnType("datetime(6)");
                    ...
                    b.HasIndex("EntityType", "ReconciliationTime");

                    b.ToTable("ReconciliationResults", (string)null);
                });
            ...
            modelBuilder.Entity("CryptoTrading.Models.TradingBot", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.Property<int>("ExecutionIntervalSeconds")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("PositionSizing")
                        .HasColumnType("JSON");
            ...
            modelBuilder.Entity("CryptoTrading.Models.TradingBotLog", b =>
                {
                    b.Property<ulong>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint unsigned");
                    ...
                    b.ToTable("TradingBotLogs");
                });

            modelBuilder.Entity("CryptoTrading.Models.TradingBotOrder", b =>
                {
                    b.Property<ulong>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint unsigned");
                    ...
                    b.ToTable("TradingBotOrders");
                });

            modelBuilder.Entity("CryptoTrading.Models.TradingBotParameter", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("TradingBotParameters");
                });

            modelBuilder.Entity("CryptoTrading.Models.TradingBotRuntimeSnapshot", b =>
                {
                    b.Property<ulong>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint unsigned");
                    ...
                    b.Property<string>("OpenPositionSummary")
                        .HasColumnType("JSON");
                    ...
                    b.ToTable("TradingBotRuntimeSnapshots");
                });

            modelBuilder.Entity("CryptoTrading.Models.TradingConfiguration", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ConfigKey", "Environment")
                        .IsUnique();
            ...
            modelBuilder.Entity("CryptoTrading.Models.TradingBot", b =>
                {
                    b.HasOne("CryptoTrading.Models.BotStrategyDefinition", "StrategyDefinition")
                        .WithMany()
            ...
            modelBuilder.Entity("CryptoTrading.Models.TradingBotLog", b =>
                {
                    b.HasOne("CryptoTrading.Models.TradingBot", "TradingBot")
                        .WithMany()
