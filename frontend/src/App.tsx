...
import BotDetail from './components/pages/trader/BotDetail';
    ...
    return (
        <BrowserRouter>
            <Routes>
                ...
                <Route path="/bot-detail" element={<ProtectedRoute><TraderPage current="bot-detail"><BotDetail /></TraderPage></ProtectedRoute>} />
