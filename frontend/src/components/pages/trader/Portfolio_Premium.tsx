            ...
            if (data.navHistory && data.navHistory.length > 0) {
                ...
                const navData = data.navHistory.map(item => {
                    try {
                        ...
                        // Format date as YYYY-MM-DD for NavChart compatibility
            ...
            <div className="grid lg:grid-cols-3 gap-6 mb-6">
                ...
                <div className="lg:col-span-2">
                    <ChartCard
                        ...
                        subtitle="Net Asset Value (NAV) over time"
                    >
                        {performanceData.length === 0 ? (
                            <div className="flex items-center justify-center h-[280px] text-gray-400">
                                <div className="text-center">
                                    <p className="mb-2">No performance data available</p>
                                    <p className="text-sm">Start trading to see your portfolio growth</p>
                                </div>
                            </div>
                        ) : (
                            <NavChart data={performanceData} />
                        )}
                    </ChartCard>
                </div>
